...
SELECT
   ...
   COALESCE(SUM(CAST(sellingprice AS NUMERIC)) FILTER (WHERE EXTRACT(HOUR FROM CAST(created AS TIMESTAMP)) BETWEEN 0 AND 2), 0) AS "00-03 AM",
   COALESCE(SUM(CAST(sellingprice AS NUMERIC)) FILTER (WHERE EXTRACT(HOUR FROM CAST(created AS TIMESTAMP)) BETWEEN 3 AND 5), 0) AS "03-06 AM",
   COALESCE(SUM(CAST(sellingprice AS NUMERIC)) FILTER (WHERE EXTRACT(HOUR FROM CAST(created AS TIMESTAMP)) BETWEEN 6 AND 8), 0) AS "06-09 AM",
   COALESCE(SUM(CAST(sellingprice AS NUMERIC)) FILTER (WHERE EXTRACT(HOUR FROM CAST(created AS TIMESTAMP)) BETWEEN 9 AND 11), 0) AS "09-12 AM",
   COALESCE(SUM(CAST(sellingprice AS NUMERIC)) FILTER (WHERE EXTRACT(HOUR FROM CAST(created AS TIMESTAMP)) BETWEEN 12 AND 14), 0) AS "12-03 PM",
   COALESCE(SUM(CAST(sellingprice AS NUMERIC)) FILTER (WHERE EXTRACT(HOUR FROM CAST(created AS TIMESTAMP)) BETWEEN 15 AND 17), 0) AS "03-06 PM",
   COALESCE(SUM(CAST(sellingprice AS NUMERIC)) FILTER (WHERE EXTRACT(HOUR FROM CAST(created AS TIMESTAMP)) BETWEEN 18 AND 20), 0) AS "06-09 PM",
   COALESCE(SUM(CAST(sellingprice AS NUMERIC)) FILTER (WHERE EXTRACT(HOUR FROM CAST(created AS TIMESTAMP)) BETWEEN 21 AND 23), 0) AS "09-12 PM"
